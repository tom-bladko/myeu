...
from trade.merchant import Merchant
...
class CenterOfTrade(object):
    ...
    def __init__(self, args = {}):
        ...
        from src.map.provinceItem import ProvinceItem
        self.location_province: ProvinceItem = db.province_manager.provinces.get( self.location_province_id )
        self.color = args.get("color", 'yellow')
    ...
    def add_province_id(self, province_id, with_neighbours = False):
        prov = db.province_manager.provinces.get( province_id)
        if prov:
